    ...
    public function run(): void
    {
        ...
        $categories = [
            ...
            [
                ...
                'commission_rate' => 2.00,
                'fields' => [
                    ['name' => 'equipment_type', 'label' => 'Equipment Type', 'type' => 'select', 'options' => ['Tractor', 'Hand Tractor', 'Rice Transplanter', 'Combine Harvester', 'Thresher', 'Sprayer', 'Irrigation Pump', 'Corn Sheller', 'Rice Mill', 'Seeder', 'Plow', 'Rotavator', 'Other'], 'required' => true, 'sort_order' => 1, 'is_searchable' => true, 'is_classification' => true],
